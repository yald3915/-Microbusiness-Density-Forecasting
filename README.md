This file is the baseline code for GoDaddy - Microbusiness Density Forecasting--Forecast Next Month’s Microbusiness Density

以上文件是GoDaddy - Microbusiness Density Forecasting--Forecast Next Month’s Microbusiness Density（微型企业密度预测）比赛的baseline代码
